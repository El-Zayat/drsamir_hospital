...
const RequestItem = ({color, Icon, name, onPress}) => {
  return (
    <Pressable
...
const HomeScreen = () => {
  const {
    ...
    isError: bannersHasError,
    data: homeBanners,
  } = useQuery('banners', EndPoints.homeBanners);
  const {
    isLoading: servicesLoading,
    isError: servicesHasError,
    data: servicesData,
  } = useQuery('services', EndPoints.services);
  const {
    isLoading: doctorsLoading,
    isError: doctorsHasError,
    data: doctorsData,
  } = useQuery('doctors', EndPoints.doctors);
  ...
  return (
    ...
    >
      ...
      <View style={styles.topContainer}>
        ...
        <View style={{marginTop: 35}}>
          ...
          <RequestItem
            ...
            onPress={() => Linking.openURL("https://dsamc.com/")}
          />
        </View>
        <Image
      ...
      <View style={{marginTop: 20}}>
        ...
        <DoctorsVertical doctors={_doctors} loading={doctorsLoading} />
