...
import {StyleSheet,TouchableOpacity,Text,Image,I18nManager,View,Dimensions,TouchableWithoutFeedback} from 'react-native';
    ...
    return(
        ...
        > 
            <View style={styles.container}>
                <Image
                    source={doctorImg? {uri:doctorImg} : require('../../../assets/images/logo.png')}   
                    // resizeMethod={"scale"}
                    resizeMode={"contain"}  
